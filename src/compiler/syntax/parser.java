...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Mon Aug 25 20:13:50 CEST 2014
  */
...
//								}
		...
		Token id = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
					...
					if(!util.checkSymbolTableScope(scope, name)){
						...
						codeBuilder.addQuadruple("MOVEADDR", refTemp, var);
		...
		Token num = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
							...
							TemporalIF eTemp = tempFactory.create();
							codeBuilder.addQuadruple("MOVENUM", eTemp, valor);
...
//					semanticErrorManager.semanticDebug("Nombre de tipo: " + listaTipos.get(i).getName());
		...
		Axiom ax = (Axiom)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
  		...
  		semanticErrorManager.semanticDebug("antes de finalCodeFactory.create(intermediateCode)");
  		semanticErrorManager.semanticDebug("ax.toString=" + ax.toString());
		...
		//	finalCodeFactory, pasandole por parámetro un nuevo objeto ExecutionEnvironmentEns2001.
  		...
  		semanticErrorManager.semanticDebug("después de finalCodeFactory.create(intermediateCode)");
