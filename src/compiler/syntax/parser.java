...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Sep 10 02:09:39 CEST 2014
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\002\042\005\000\002\042\003\000\002\026\005\000" +
    "\002\065\002\000\002\025\007\000\002\025\006\000\002" +
  ...
  protected static final short[][] _action_table = 
    ...
    "\220\001\002\000\004\041\uffcb\001\002\000\020\003\uffb7" +
    "\004\uffb7\005\uffb7\006\221\014\uffb7\032\uffb7\035\uffb7\001" +
    ...
    "\041\uffb6\001\002\000\004\041\uffb5\001\002\000\014\024" +
    ...
    "\uffb8\043\174\044\173\045\175\001\002\000\020\004\154" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		Token str = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 75: // sentenciaIO ::= PUTLINE LEFTBRACKET NT$18 expresion RIGHTBRACKET 
            {
              SentenciaIO RESULT =null;
...
//--------
						semanticErrorManager.semanticDebug("En PutLine(expresion) su termporal= " + temporalExpr + " se ha cogido del de la expresion=" + expr.getTemporal());
//--------															
						codeBuilder.addQuadruples(expr.getIntermediateCode());
...
//								//Simbolo
								...
								if(typeSymbol instanceof TypeRecord){
									semanticErrorManager.semanticDebug("Tipo del símbolo EEEES REcord");
									//Generación de CódigoIntermedio para Asignación a un campo de un registro								
								...
								else if (typeSymbol instanceof TypeSimple){
...
//																	
//									Variable var = new Variable(ref.getName(), scopeManager.getCurrentScope(), symvar);
//									semanticErrorManager.semanticDebug("En SENTENCIA ASIGNACION la variable tiene name=" + var.getName());
//-------
//									//codeBuilder.addQuadruple("MUL", expTemp, rTempIndex, new Value(typeSymbol.getSize()));
//									//codeBuilder.addQuadruple("ADD", expTemp, expTemp, rTemp);
//									//codeBuilder.addQuadruple("ADD", expTemp, expTemp, rTempOffset);
//									if (ref.getType() instanceof TypeRecord)
//										codeBuilder.addQuadruple("ASSIGNREG", var, var2, expTemp);
//									else
//										codeBuilder.addQuadruple("ASSIGN", var, expTemp);
//
//-------									
//									
//_____								//codeBuilder.addQuadruple("ASSIGN", var, expTemp);
//									 
//									List intermediateCode = codeBuilder.create();
//									asignacion.setIntermediateCode(intermediateCode);
//									semanticErrorManager.semanticDebug("["+ scopeManager.getCurrentScope().getLevel() +"] CI - ASIGNACIÓN->ref := exp" + asignacion.getIntermediateCode());									
...
//								}
		...
		Token id = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
					...
					if(!util.checkSymbolTableScope(scope, name)){
						...
						if (typeref instanceof TypeRecord){
							//TypeRecord tipoRec = (TypeRecord)ref.getVarRecord().getType();
							//int idOffset = ref.getCampoRecord().getOffset();							
							//Variable var = new Variable(name, ref.getVarRecord());

							codeBuilder.addQuadruple("MOVEREG", refTemp, ref.getVarRecord().getOffset(), ref.getVarRecord());
							ref.setTemporal(refTemp);
							List intermediateCode = codeBuilder.create();
							ref.setIntermediateCode(intermediateCode);
						}
						else	//Tipo de la referencia será de tipo Simple, Procedure, Function, etc.. 
						{
							...
							{	
								...
								if(tRec.containsField(innerName)){
									...
									Referencia ref = new Referencia(referType, referName);
										//Construimos un SymbolVariable para el campo de registro y otro para la variable de registro
									SymbolVariable symVarCampo = new SymbolVariable(scopeManager.getCurrentScope(), innerName, innerType);
									//Añadimos el campodelRegistro a la referencia
									ref.setCampoRecord(symVarCampo);
									SymbolVariable symVarReferencia = (SymbolVariable) simboloReferencia;
									ref.setVarRecord(symVarReferencia);									
...
//									codeBuilder.addQuadruple("MV", refTemp, ref.getCampo);
//									ref.setTemporal(refTemp);
//									List intermediateCode = codeBuilder.create();
//									ref.setIntermediateCode(intermediateCode);
									...
									{	
										...
										for (int j=0; j < decVarRegistro.getSize(); j++)
										{
											...
											if (typeRecord.containsField(decVarRegistro.getIdentifiersListItem(j)))
												...
												typeRecord.addCampoRegistro(symbolVarReg);											
										}										
									}
									tablaTipos.addType(id.getLexema(), typeRecord);
  				...
  				if (s instanceof SymbolVariable)
  				{
  					...
  					{ //Si la variable es global, establecemos su dirección comenzando en la pos.0 de memoria
  						...
  						if (symtype instanceof TypeRecord){
  							...
  							//semanticErrorManager.semanticDebug("El tamano del registro es=" + tR.getMemorySize());
  						}
  						else
