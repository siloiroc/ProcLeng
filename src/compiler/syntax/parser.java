...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri Sep 05 14:42:36 CEST 2014
  */
...
//								}
								...
								//Creamos un objeto tipo Variable con nombre el id de la referencia
//								Variable var = new Variable(ref.getValue());
		...
		Token id = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
					...
					if(!util.checkSymbolTableScope(scope, name)){
						...
						if(symbol instanceof SymbolConstant){
							SymbolConstant symconst = (SymbolConstant) symbol;
							Value valor = new Value(symconst.getValue());
							codeBuilder.addQuadruple("MOVE", refTemp, valor);
						}
						else{
		...
		Token id = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
							...
							if(referType instanceof TypeRecord)
							{
								...
								if(tRec.containsField(id.getLexema())){
									...
									codeBuilder.addQuadruple("MOVE", refTempOffset, idOffset);
									ref.setTemporal(refTemp);
		...
		Token num = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
							...
							TemporalIF eTemp = tempFactory.create();
							codeBuilder.addQuadruple("MOVE", eTemp, new Value(value));
  			...
  			for (SymbolIF s : symbols){
  				if (s instanceof SymbolVariable)
  				{
  					...
  					{ //Si la variable es global, establecemos su dirección comenzando en la pos.0 de memoria
  						...
  						semanticErrorManager.semanticDebug("Tamaño de la variable: " + symvar.getType().getSize());
  						semanticErrorManager.semanticDebug("MEMORIA - Variable estará en la posición: " + gAddress + " de memoria");
