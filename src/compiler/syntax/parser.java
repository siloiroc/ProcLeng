...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Aug 21 18:53:08 CEST 2014
  */
...
//								}
		...
		Token id = (Token)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
					...
					//semanticErrorManager.semanticDebug("En Referencia -> ID(" + id.getLexema() + ")");
					...
					if(!util.checkSymbolTableScope(scope, name)){
						...
						SymbolVariable symbolVar = (SymbolVariable) scopeManager.searchSymbol(name);
 ...
 //semanticErrorManager.semanticDebug("Sentencia -> sentenciaIO"); 
          ...
          case 50: // bloqueSentencias ::= empty 
            {
		 	...
		 	//semanticErrorManager.semanticDebug("En bloqueSentencias -> empty");
							...
							{
								bloqueSent.setExisteReturn(false);
								semanticErrorManager.semanticDebug("Empty: El level es > 0 y he puesto bloqueSent.setExisteReturn(false)");
								if (!bloqueSent.isExisteReturn()){
									semanticErrorManager.semanticFatalError("ERROR - No existe sentenciaReturn en el subprograma");
								}								
							}
		...
		Sentencia sent = (Sentencia)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
							...
							{	//Estamos en el bloqueSentencias de un subprograma
								...
								{
									semanticErrorManager.semanticDebug("Soy una sentencia Return");
									bloqueSent.setExisteReturn(true);
									semanticErrorManager.semanticDebug("No empty:El level es > 0 y he puesto bloqueSent.setExisteReturn(true)");
								}
								else
								{
									semanticErrorManager.semanticDebug("sent no es instance de SentenciaReturn");							
									if (!bloqueSent.isExisteReturn()){
										semanticErrorManager.semanticFatalError("ERROR - No existe sentenciaReturn en el subprograma '" + symbol.getName() + "'");
									}
								}
							RESULT = bloqueSent;
							}
